...
def generate_env(
    ...
    cv2.rectangle(env_img, (25, 0), (25+25, 0 + 200), (0, 0, 0), -1)
    rectangle_obstacles.append([25, 0, 25, 200])
    
    cv2.rectangle(env_img, (75, 25), (75+25, 25 + 200), (0, 0, 0), -1)
    rectangle_obstacles.append([75, 25, 25, 200])
    
    cv2.rectangle(env_img, (125, 0), (125+25, 0 + 200), (0, 0, 0), -1)
    rectangle_obstacles.append([125, 0, 25, 200])
    
    cv2.rectangle(env_img, (175, 25), (175+25, 25 + 200), (0, 0, 0), -1)
    rectangle_obstacles.append([175, 25, 25, 200])
...
for mode in ['train']:
    ...
    geeky_file = open('data/random_2d/train/envs.json', 'r')
    mode_env_list = json.load(geeky_file)
    
    lenn = len(mode_env_list)
    print(len(mode_env_list))
    
    while len(mode_env_list) < lenn+1:
        total_env_count += 1
        ...
        for idxx in range(num_samples_per_env):
